...
export default (() => {
	return <Theme theme={theme}>
		...
		<Box min-width="100px" min-height="100px" />
		<Section md-padding="60px 0 30px 0" quarkly-title="Footer-15" padding="90px 0 30px 0">
			<Box
				min-width="100px"
				min-height="100px"
				display="flex"
